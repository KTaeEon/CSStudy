...
namespace Ch02
{
    internal class _6_문자열
    {
        static void Main(string[] args)
        {
            ...
            //문자열 인덱스
            Console.WriteLine("'G'인덱스 :"+greeting.IndexOf('G'));        // 앞에서부터 서치
            Console.WriteLine("'M'인덱스 :"+greeting.IndexOf('M'));
            Console.WriteLine("'o'인덱스 :"+greeting.IndexOf('o'));
            Console.WriteLine("'o'인덱스 :"+greeting.LastIndexOf('o'));    // 뒤에서부터 서치
            Console.WriteLine();


            //문자열 자르기
            Console.WriteLine("greeting 0 에서 4길이의 문자열 : "+greeting.Substring(0, 4));  // (0(시작), 4(길이))
            Console.WriteLine("greeting 5 에서 7길이의 문자열 : "+greeting.Substring(5, 7));
            Console.WriteLine("greeting 5 에서 마지막까지 문자열 : "+greeting.Substring(5));
            Console.WriteLine();
