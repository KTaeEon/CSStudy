...
* 
* 연산자(Operator)
*  _ 변수에 저장된 데이터를 가공하기 위해 연산자를 사용
*  - 연산자는 크게 산술, 증감, 복합대입, 비교, 논리 연산자등이 있다. 
*/
namespace Ch02
{
    internal class _3_연산자
    {
        static void Main3(string[] args)
        {
            ...
            // 논리 연산자                     // && 하나라도 f면 f결과 || 하나라도 t면 t결과
            bool res1 = var1 > 1 && var2 > 2;  // var1은 1보다 크고 그리고 var2는 2보다 크다. (Fasle)
            bool res2 = var1 > 0 && var2 > 1;  // var1은 0보다 크고 그리고 var2는 1보다 크다. (True)
            bool res3 = var1 > 1 || var2 > 2;  // var1은 1보다 크고 또는 var2는 1보다 크다. (False)
            bool res4 = var1 > 0 || var2 > 2;  // var1은 0보다 크고 또는 var2는 2보다 크다. (True) 
            bool res5 = !(var1 > var2);        // var1은 var2보다 크지않다. (True) (! = Not을 의미 )
